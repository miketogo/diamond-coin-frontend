  ...
  return (
    <section className="overview">
      <div className="overview__intro">
        <h2 className="overview__intro-title">Get yourself<br />a diamond<span className="overview__intro-title-span"><img className="overview__intro-title-diamond" src={diamond} alt="diamond" /></span></h2>
